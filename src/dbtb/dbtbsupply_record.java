...
public class dbtbsupply_record {
	private int SupplyID,S_VendorID,CaseWeight,MaximumRefills,CurrentQtyOnHand,MinimumQtyOnHand;
	private String SupplyDescription,CasePack,Brand,CaseSubBreak,Barcode,UnitOfMeasure,ActiveIngridient,LotNo;
	...
	public int getS_VendorID() {
		return S_VendorID;
	}
	public void setS_VendorID(int i) {
		this.S_VendorID = i;
	}
	...
	public void setSupplyDescription(String s) {
		this.SupplyDescription = s;
	}
