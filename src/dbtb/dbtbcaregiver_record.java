...
public class dbtbcaregiver_record {
	...
	private int Caregiver_ID,CR_employeeID,Age,PinCode,Phone;
	private byte Qualification;
	
	public int getCaregiver_ID() {
		return Caregiver_ID;
	}
	public void setCaregiver_ID(int ci) {
		this.Caregiver_ID = ci;
	}
	public int getCR_employeeID() {
		return CR_employeeID;
	}
	public void setCR_employeeID(int sci) {
		this.CR_employeeID = sci;
	}
	public int getAge() {
		return Age;
	}
