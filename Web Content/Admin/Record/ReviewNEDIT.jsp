...
<body>
	<%
		int id=Integer.parseInt(request.getParameter("n_RatingsID"));
		dbtbn_ratings c=ch_ratingsDAO.getRecordN(id);
	%>
	<form id="regForm" action="Rev.jsp">
		<div class="modal fade" id="myModal" role="dialog">
				...
				<label>Date</label>
				<input type="hidden" name="n_RatingsID" value="<%=id %>">
				<input type="hidden" name="NR_NurseID" value="<%=c.getNR_NurseID()%>">
					</br>
