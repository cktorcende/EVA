<%@ page import="conn.DbCon,dao.ch_AchievementDAO,dbtb.dbtbcs_achievements, java.sql.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
		<% 
		 	int id=Integer.parseInt(request.getParameter("CS_AchievementID"));
			dbtbcs_achievements c=ch_AchievementDAO.getCSRecord(id);
		%>
		...
		<div class="modal fade" id="myModal" role="dialog">
 						<div class="modal-dialog">
    					  <div class="modal-content">
					        ...
					        <input type="hidden" name="CSA_CashierID" value="<%=c.getCSA_CashierID() %>">
					       	<label>Cashier</label>
			        		 <input type="hidden" id='CS_ID' name="CSA_CashierID"/>
					        		 ...
					        		 <%
								    	try{
								    		...
								    		ResultSet rs = stmt.executeQuery("SELECT Cashier_ID,CONCAT(LastName,', ',FirstName,' ',MiddleName) FROM cashier_record WHERE Cashier_ID=" +c.getCSA_CashierID());					                        	
								    %>
