<%@ page import="conn.DbCon,dao.ch_AchievementDAO,dbtb.dbtbch_achievements, java.sql.*"%>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>EVA:ACHIEVEMENTS</title>
...
<body>
		<% 
		 	int id=Integer.parseInt(request.getParameter("CH_AchievementID"));
			dbtbch_achievements c=ch_AchievementDAO.getCHRecord(id);
		%>
		...
		<div class="modal fade" id="Modal" role="dialog">
 						<div class="modal-dialog">
    					  <div class="modal-content">
					        ...
					        <input type="hidden" name="A_ChefID" id='CH_ID' value="<%=c.getA_ChefID() %>">
					       <label>Chef</label>
					        		 ...
					        		 <%
								    	try{
								    		...
								    		ResultSet rs = stmt.executeQuery("SELECT chef_ID,CONCAT(Lastname,', ',FirstName,' ',MiddleName) FROM chef_record WHERE chef_ID=" + c.getA_ChefID());					                        	
								    %>
