...
<body>
		<%
			int id=Integer.parseInt(request.getParameter("N_AssignedID"));
			dbtbn_assigned c=ch_assignedDAO.getNRecord(id);
		%>
		...
		<div class="modal fade" id="myModal" role="dialog">
 						<div class="modal-dialog">
    					  <div class="modal-content">
					        ...
					        <label>Nurse</label>
					        	<input type="hidden" name="NAS_NurseID" value="<%=c.getNAS_NurseID()%>">
					        		<%
								    	try{
								    		Connection con=DbCon.getCon();
								    		Statement stmt = con.createStatement();
								    		ResultSet rs = stmt.executeQuery("SELECT Nurse_ID,CONCAT(LastName,', ',FirstName,' ',MiddleName) FROM nurse_record WHERE Nurse_ID="+c.getNAS_NurseID());					                        	
								    %>
							...
							<label>Date Started</label>
								...
								<br/>
									...
									<input type="hidden" id='P_ID' name="AssignedPatient" value="<%=c.getN_AssignedPatientID()%>"/>
					        		
					        		 <%
								    	try{
								    		Connection con=DbCon.getCon();
								    		Statement stmt = con.createStatement();
								    		ResultSet rs = stmt.executeQuery("SELECT Patient_ID,CONCAT(Surname,', ',FirstName,' ',MiddleName) FROM client_record WHERE Patient_ID=" + c.getN_AssignedPatientID());					                        	
								    %>
