...
<body>
	<%
		int id=Integer.parseInt(request.getParameter("d_RatingsID"));
		dbtbd_ratings c=ch_ratingsDAO.getRecordD(id);
	%>
	<form id="regForm" action="Rev.jsp">
		<div class="modal fade" id="myModal" role="dialog">
				...
				<label>Date</label>
				<input type="hidden" name="d_RatingsID" value="<%=id %>">
				<input type="hidden" name="CHR_ChefID" value="<%=c.getDR_DoctorID()%>">
					</br>
