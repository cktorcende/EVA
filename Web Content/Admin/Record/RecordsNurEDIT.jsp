...
<form id="regForm" action="RecN.jsp">
		...
		<% 
			int id=Integer.parseInt(request.getParameter("Nurse_ID"));
			dbtbNurse_record n =EmployeeRecordDAO.getRecordN(id);
		...
		<div class="modal fade" id="RegModal" role="dialog">
 					  ...
 					  <div class="modal-content">
 					    <div class="modal-header">
     						<button type="button" class="close" data-dismiss="modal">&times;</button>
     							<h3 class="modal-title">Edit Nurse</h3>
    						</div>
				...
				<input type="hidden" name="Nurse_ID" value="<%=id %>">
