...
<body>
	<%
		int id=Integer.parseInt(request.getParameter("ch_RatingsID"));
		dbtbch_ratings c=ch_ratingsDAO.getRecordCH(id);
	%>
	<form id="regForm" action="Rev.jsp">
		<div class="modal fade" id="myModal" role="dialog">
				...
				<input type="hidden" name="CHR_ChefID" value="<%=c.getCHR_ChefID()%>">
					</br>
