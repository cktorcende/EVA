...
<body>
	<%
		int id=Integer.parseInt(request.getParameter("cs_RatingsID"));
		dbtbcs_ratings c=ch_ratingsDAO.getRecordCS(id);
	%>
	<form id="regForm" action="Rev.jsp">
		<div class="modal fade" id="myModal" role="dialog">
				...
				<label>Date</label>
				<input type="hidden" name="cs_RatingsID" value="<%=id %>">
				<input type="hidden" name="CSR_CashierID" value="<%=c.getCSR_CashierID()%>">
					</br>
