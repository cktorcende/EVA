...
<body>
	<%
		 int id=Integer.parseInt(request.getParameter("D_ExperienceID"));
		dbtbd_experience c=ch_experienceDAO.getRecordD(id);
	%> 
		...
		<div class="modal fade" id="Modal" role="dialog">
 						<div class="modal-dialog">
    					  <div class="modal-content">
							...
							<input type="hidden" name="DoctorID" id="D_ID"value="<%=c.getDoctorID() %>">
								
					        		 <%
								    	try{
								    		Connection con=DbCon.getCon();
								    		Statement stmt = con.createStatement();
								    		ResultSet rs = stmt.executeQuery("SELECT Doctor_ID,CONCAT(LastName,', ',FirstName,' ',MiddleName) FROM doctor_record WHERE Doctor_ID="+ c.getDoctorID());					                        	
								    %>
