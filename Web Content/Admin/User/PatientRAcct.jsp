...
<body>
	...
	<div id="resTable">
		...
		<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
			<% List<dbtbUser> l=UserCRUDDAO.getAllRecordsC();
	...
	<div id="Search">	
		<form>
			<h2>Search For Patient Relative Account</h2>
  					  ...
  					  <div class="modal-content">
  					    <div class="modal-header">
      						<button type="button" class="close" data-dismiss="modal">&times;</button>
      							<h3 class="modal-title">Add Patient Relative Account</h3>
     						</div>
			        		<div class="modal-body">
								<label>Surname</label><input type="text" name="Surname" size=60 data-error="limit up to 30 characters only" ><br/>
								<label>FirstName</label><input type="text" name="FirstName" size=60 data-error="limit up to 30 characters only"><br/>
								<label>MiddleName</label><input type="text" name="MiddleName"size=60 data-error="limit up to 30 characters only"><br/>
								<label>Username</label><input type="text" name="Username" data-error="limit up to 30 characters only" size=60><br/>
