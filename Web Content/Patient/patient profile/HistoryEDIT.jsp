...
<div id="info">
	...
	<form name="inf">
		...
		<label>PATIENT NAME:</label><input type="text" size=60 name="FirstName" value="<%=cl.getSurname().toUpperCase() %>, <%=cl.getFirstName().toUpperCase() %> <%=cl.getMiddleName().toUpperCase() %>"> 
