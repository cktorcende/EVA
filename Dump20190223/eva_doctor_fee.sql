...
CREATE TABLE `doctor_fee` (
  `DFeeID` int(11) NOT NULL AUTO_INCREMENT,
  `DPatientID` int(11) NOT NULL,
  `BDoctorID` int(11) NOT NULL,
...
LOCK TABLES `doctor_fee` WRITE;
/*!40000 ALTER TABLE `doctor_fee` DISABLE KEYS */;
INSERT INTO `doctor_fee` VALUES (1,2,1,300.9,90,'2018-09-10','2018-10-10','2018-10-10',0,'night','unpaid',NULL),(2,2,1,400,340,'2018-12-14','2019-01-14','2019-01-14',1,'Afternoon',NULL,NULL);
