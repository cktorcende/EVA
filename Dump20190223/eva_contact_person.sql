...
CREATE TABLE `contact_person` (
  ...
  `PTContactID` int(11) NOT NULL DEFAULT '0',
  `ContactPerson` varchar(45) NOT NULL,
  `Relationship` varchar(45) DEFAULT NULL,
  `Age` int(11) NOT NULL,
  `PrimaryAddress` varchar(45) NOT NULL,
  `PCity` varchar(20) NOT NULL,
  `SecondaryAddress` varchar(45) DEFAULT NULL,
  `SCity` varchar(20) DEFAULT NULL,
  `Mobile` varchar(13) NOT NULL,
  `Phone` mediumint(11) unsigned zerofill DEFAULT NULL,
  `ContactNo` mediumint(11) unsigned zerofill DEFAULT NULL,
  `Work` varchar(45) NOT NULL,
  `WorkPhone` varchar(13) NOT NULL,
  `WorkAddress` varchar(45) NOT NULL,
...
-- Dump completed on 2019-02-23  9:25:25
